/**
  ...
  *          the 53l4a2_ranging_sensor.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef XNUCLEO_53L4A2_RANGING_SENSOR_H
#define XNUCLEO_53L4A2_RANGING_SENSOR_H
...
/** @defgroup XNUCLEO_53L4A2_RANGING_SENSOR RANGING SENSOR
  * @{
  */

/** @defgroup XNUCLEO_53L4A2_RANGING_SENSOR_Exported_Constants Exported Constants
  * @{
  */
...
#define VL53L4A2_DEV_LEFT      (0U) /*!< left satellite device */
#define VL53L4A2_DEV_CENTER    (1U) /*!< center (built-in) device */
#define VL53L4A2_DEV_RIGHT     (2U) /*!< right satellite device */

/**
  * @}
  */

/** @defgroup XNUCLEO_53L4A2_RANGING_SENSOR_Exported_Types Exported Types
  * @{
  */
typedef struct
{
...
/** @defgroup XNUCLEO_53L4A2_RANGING_SENSOR_Exported_Variables Exported Variables
  * @{
  */
extern void *VL53L4A2_RANGING_SENSOR_CompObj[RANGING_SENSOR_INSTANCES_NBR];
/**
  * @}
  */

/** @defgroup XNUCLEO_53L4A2_RANGING_SENSOR_Exported_Functions Exported Functions
  * @{
  */
...
#endif /* XNUCLEO_53L4A2_RANGING_SENSOR_H */
