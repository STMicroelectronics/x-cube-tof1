/**
  ...
  *          the 53l4a1_ranging_sensor.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef XNUCLEO_53L4A1_RANGING_SENSOR_H
#define XNUCLEO_53L4A1_RANGING_SENSOR_H
...
/** @defgroup XNUCLEO_53L4A1_RANGING_SENSOR RANGING SENSOR
  * @{
  */

/** @defgroup XNUCLEO_53L4A1_RANGING_SENSOR_Exported_Constants Exported Constants
  * @{
  */
...
#define RS_IT_DEFAULT        (VL53L4CD_IT_DEFAULT)       /*!< IT if new measurement is ready (no thresholds) */
#define RS_IT_IN_WINDOW      (VL53L4CD_IT_IN_WINDOW)     /*!< IT if distance >= LowThreshold AND distance <= HighThreshold */
#define RS_IT_OUT_OF_WINDOW  (VL53L4CD_IT_OUT_OF_WINDOW) /*!< IT if distance < LowThreshold OR distance > HighThreshold */
#define RS_IT_BELOW_LOW      (VL53L4CD_IT_BELOW_LOW)     /*!< IT if distance < LowThreshold */
#define RS_IT_ABOVE_HIGH     (VL53L4CD_IT_ABOVE_HIGH)    /*!< IT if distance > HighThreshold */
...
#define VL53L4A1_DEV_LEFT      (0U) /*!< left satellite device */
#define VL53L4A1_DEV_CENTER    (1U) /*!< center (built-in) device */
#define VL53L4A1_DEV_RIGHT     (2U) /*!< right satellite device */

/**
  * @}
  */

/** @defgroup XNUCLEO_53L4A1_RANGING_SENSOR_Exported_Types Exported Types
  * @{
  */
typedef struct
{
...
/** @defgroup XNUCLEO_53L4A1_RANGING_SENSOR_Exported_Variables Exported Variables
  * @{
  */
extern void *VL53L4A1_RANGING_SENSOR_CompObj[RANGING_SENSOR_INSTANCES_NBR];
/**
  * @}
  */

/** @defgroup XNUCLEO_53L4A1_RANGING_SENSOR_Exported_Functions Exported Functions
  * @{
  */
...
#endif /* XNUCLEO_53L4A1_RANGING_SENSOR_H */
