...
static void MX_VL53L4ED_SimpleRanging_Init(void);
...
void MX_TOF_Init(void)
{
  ...
  MX_VL53L4ED_SimpleRanging_Init();
...
void MX_TOF_Process(void)
{
  ...
  MX_VL53L4ED_SimpleRanging_Process();
...
static void MX_VL53L4ED_SimpleRanging_Init(void)
{
  ...
  printf("VL53L4ED Simple Ranging demo application\n");
  status = CUSTOM_RANGING_SENSOR_Init(CUSTOM_VL53L4ED);
