...
**Please note that X-NUCLEO-53L8A1B board (PCB4285B) must be used for the multiple sensors example application.
The X-NUCLEO-53L8A1A (aka PCB4285A) may not support the Left & Right satellite boards if voltage converters are soldered onto them.**
