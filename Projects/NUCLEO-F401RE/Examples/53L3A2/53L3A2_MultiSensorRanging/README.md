...
This example application illustrates how to use the X-NUCLEO-53L3A2 expansion board with a STM32 Nucleo board 
...
### <b>Hardware and Software environment</b>
  ...
  - Make sure that two VL53L3CX-SATEL breakout boards are plugged correctly on the X-NUCLEO-53L3A2 expansion board.
